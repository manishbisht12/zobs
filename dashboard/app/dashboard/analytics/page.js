      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {metrics.map((metric, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-gradient-to-br text-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow"
              style={{ backgroundImage: `linear-gradient(135deg, var(--gradient-${metric.color}-500), var(--gradient-${metric.color}-600))` }}
            >
