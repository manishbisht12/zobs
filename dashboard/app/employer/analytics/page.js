...
import { TrendingUp, Users, Briefcase, Eye, Calendar, DollarSign, MousePointer, BarChart3 } from 'lucide-react';

export default function EmployerAnalyticsPage() {
  const metrics = [
    { label: 'Total Job Views', value: '12.4K', change: '+12.5%', icon: Eye, color: 'blue' },
    { label: 'Total Applicants', value: '156', change: '+8.3%', icon: Users, color: 'green' },
    { label: 'Conversion Rate', value: '4.2%', change: '+2.1%', icon: TrendingUp, color: 'purple' },
    { label: 'Avg. Response Time', value: '2.3 days', change: '-5.7%', icon: MousePointer, color: 'orange' },
  ];
  ...
  const topJobs = [
    ...
    { id: 5, title: 'DevOps Engineer', views: 1890, applications: 39, conversion: '2.1%' },
  ];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-md border border-gray-200 p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Job Performance Overview</h2>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-600 text-sm">Interview Conversion</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-600 text-sm">Hire Rate</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-600 text-sm">Avg. Time to Fill</span>
