...
export default function EmployerJobsPage() {
  ...
  const jobs = [
    ...
    { id: 3, title: 'Backend Engineer', applicants: 67, status: 'Active', salary: '$90K-$130K', location: 'San Francisco', posted: '5 days ago', views: 312 },
    { id: 4, title: 'Marketing Manager', applicants: 28, status: 'Closed', salary: '$60K-$85K', location: 'Chicago', posted: '1 week ago', views: 156 },
    { id: 5, title: 'DevOps Engineer', applicants: 54, status: 'Active', salary: '$85K-$115K', location: 'Austin', posted: '4 days ago', views: 278 },
    { id: 6, title: 'Data Scientist', applicants: 91, status: 'Active', salary: '$100K-$150K', location: 'Seattle', posted: '1 day ago', views: 445 },
  ];
